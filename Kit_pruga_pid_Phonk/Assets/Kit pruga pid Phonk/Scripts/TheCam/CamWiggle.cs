...
public class CamWiggle : MonoBehaviour {
    ...
    void Update() {
        ...
        Vector3 camRot = new Vector3(MyTransform.localPosition.x, MyTransform.localPosition.y, Pssd * AmplitudeRot + DefCamRot);
        // Интерполяция поворота (сглаживание)
        MyTransform.localEulerAngles = Vector3.Lerp(MyTransform.localPosition, camRot, Time.deltaTime * Smooth);
    }
